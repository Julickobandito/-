...
class IncomeBookRecordList extends CommonComponent
{
    ...
    {
        return view('livewire.accountant.income-book-record-list');
    }
    ...
    public function mount() {
        ...
        if(isset($filters['book_id'])) {
            ...
            $service = new RegisterIncomeService($this);
            $this->varbook_type = $service->getIncomeBookFund($this->book_id);
    ...
    public function openInfoBookRecordModal($id) {
        ...
        if($item = IncomeBookRecord::find($id)) {
