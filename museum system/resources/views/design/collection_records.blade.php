...
@section('content')
    <div class="wrapper">
        <div style="display: flex; justify-content: space-between; align-items: baseline">
            ...
            <a href="/cartoteca_choose" class="btn-main">Додати в колекцію</a>
        </div>
        <div class="div">
            <table class="table-edit" style="width: 80%;">
                ...
                <tr class="table-row">
                    ...
                    <td class="last-td d-flex justify-content-end">
                        <button type="button" class="btn-sec" data-bs-toggle="modal" data-bs-target="#viewRecord">
                            Переглянути</button>
        ...
        <div class="modal fade" id="viewRecord" tabindex="-1" aria-labelledby="view" aria-hidden="true">
