...
@section('content')
    <div class="wrapper">
        <div style="display: flex; justify-content: space-between; align-items: baseline">
            <h1 class="title">Книги надходження</h1>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                        type="button" role="tab" aria-controls="home" style="color: #323461;" aria-selected="true">Основний фонд</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                        type="button" role="tab" aria-controls="profile" style="color: #323461;" aria-selected="false">Допоміжний фонд</button>
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="div">
                    <table class="table-edit" style="width: 50%;">
                        ...
                        <tr class="table-row">
                            <td><a href="/income_tom" class="link">Том 1.</a></td>
                            <td>Завершений</td>
                            <td>№1 - №456</td>
                        ...
                        <tr class="table-row">
                            <td><a href="/income_tom" class="link">Том 2.</a></td>
                            <td>Активний</td>
                            <td>----</td>
                            <td class="last-td d-flex justify-content-end align-items-baseline">
                                <button type="button" class="btn-sec" data-bs-toggle="modal" data-bs-target="#editMuseum">Редагувати</button>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="div">
                    <table class="table-edit" style="width: 50%;">
                        ...
                        <tr class="table-row">
                            <td><a href="#" class="link">Том 1.</a></td>
                            <td>Завершений</td>
                            <td>№1 - №456</td>
                            <td class="last-td d-flex justify-content-end align-items-baseline">
                                <button type="button" class="btn-img" data-bs-toggle="modal" data-bs-target="#tomInfo"
                        ...
                        <tr class="table-row">
                            <td><a href="#" class="link">Том 2.</a></td>
                            <td>Завершений</td>
                            <td>№1 - №456</td>
                            <td class="last-td d-flex justify-content-end align-items-baseline">
                                <button type="button" class="btn-img" data-bs-toggle="modal" data-bs-target="#tomInfo"
